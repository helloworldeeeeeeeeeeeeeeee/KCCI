...
parser.add_argument('--contrastive_loss_weight', type=float, default=1.00, help='contrastive_loss')

# knowledge_gate
parser.add_argument('--use_knowledge_gate', type=bool, default=True, help='whether use_knowledge_gate')

# kg 辅助 loss
parser.add_argument('--use_kg_loss', type=bool, default=True, help='whether use_kg_loss')
